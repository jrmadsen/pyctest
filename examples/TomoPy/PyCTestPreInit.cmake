...
if(CONDA_PACKAGE_INSTALL)
    ...
    execute_process(COMMAND ${CONDA_EXE} update -n base conda)
    execute_process(COMMAND ${CONDA_EXE} install -n base python=${PYTHON_VERSION} ${CONDA_PKGS})
    # update matplotlib and freetype due to MacOS issues with default
    if(APPLE)
        execute_process(COMMAND ${CONDA_EXE} update -n base freetype matplotlib)
    endif(APPLE)
    execute_process(COMMAND ${CONDA_EXE} install -n base python=${PYTHON_VERSION} ${CONDA_PKGS})
endif()
